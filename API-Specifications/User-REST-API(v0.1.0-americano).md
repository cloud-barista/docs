...
### [클라우드 인프라 연동 정보 통합 관리 (CB-Spider)] 
  ...
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/spider/ccim/ (확정)
...
#### [멀티 클라우드 네임스페이스 관리]
  ...
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/tumblebug/namespace/ (확정)
  * Leader: [@seokho-son](https://github.com/seokho-son) [@jihoon-seo](https://github.com/jihoon-seo)
 
#### [멀티 클라우드 인프라 자원(MCIR) 관리]
  * MCIR관련 등록/생성 및 관리
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/tumblebug/mcir/ (확정)
  * Leader: [@jihoon-seo](https://github.com/jihoon-seo) [@seokho-son](https://github.com/seokho-son)
 
#### [멀티 클라우드 인프라 서비스(MCIS) 관리]
  * MCIS 생성/제어 및 관리
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/tumblebug/mcis/ (확정)
  * Leader: [@seokho-son](https://github.com/seokho-son) [@jihoon-seo](https://github.com/jihoon-seo)
 
#### [멀티 클라우드 인프라 서비스 특화 기능]
  * 동일 Subnet & Load Balancing 기능
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/tumblebug/special-svc/ (1차확정)
...
### [멀티 클라우드 인프라 서비스 통합 모니터링 (CB-Dragonfly)]
  ...
  * API 규격/샘플: https://cloud-barista.github.io/rest-api/v0.1.0/dragonfly/ (1차확정)
