...
[2. 멀티 클라우드 서비스 공통 플랫폼 개요](#멀티-클라우드-서비스-공통-플랫폼-개요)

[3. 사용자 정의](#사용자-정의)

[4. 사용 시나리오](#사용-시나리오)
- [4.1. 멀티 클라우드 연동 정보 등록 시나리오](#멀티-클라우드-연동-정보-등록-시나리오)
- [4.2. 멀티 클라우드 인프라 서비스 활용 시나리오](#멀티-클라우드-인프라-서비스-활용-시나리오)
- [4.3. 멀티 클라우드 애플리케이션 서비스 활용 시나리오](#멀티-클라우드-애플리케이션-서비스-활용-시나리오)
- [4.4. 멀티 클라우드 통합 모니터링 시나리오](#멀티-클라우드-통합-모니터링-시나리오)

[5. 사용자 요구사항](#_Toc49096544)

[6. 시스템 요구사항](#시스템-요구-사항)

- [6.1. 클라우드 바리스타 웹/CLI 인터페이스 기능 (WCI: Cloud-Barista Web/CLI Interface)](#_Toc49096546)

- [6.2. 클라우드 바리스타 개방형 API (API: Cloud-Barista Open API)](#클라우드-바리스타-개방형-api-api-cloud-barista-open-api)

- [6.3. 멀티 클라우드 인프라 연동 기능 (MIF: Multi-Cloud Infrastructure Federation)](#멀티-클라우드-인프라-연동-기능-mif-multi-cloud-infrastructure-federation)

- [6.4. 멀티 클라우드 인프라 서비스 통합 관리 기능 (MIS: Multi-Cloud Infrastructure Service Management)](#멀티-클라우드-인프라-서비스-통합-관리-기능-mis-multi-cloud-infrastructure-service-management)

- [6.5. 멀티 클라우드 애플리케이션 통합 관리 (MAM: Multi-Cloud Application Management)](#멀티-클라우드-애플리케이션-통합-관리-mam-multi-cloud-application-management)

- [6.6. 멀티 클라우드 통합 모니터링 기능 (MSM: Multi-Cloud Service Monitoring)](#멀티-클라우드-통합-모니터링-기능-msm-multi-cloud-service-monitoring)

- [6.7. 클라우드 바리스타 운용 및 관리 기능 (COM: Cloud-Barista Operation and Management)](#클라우드-바리스타-운용-및-관리-기능-com-cloud-barista-operation-and-management)

- [6.8. 클라우드 바리스타 개발 및 시험 지원 기능 (CDT: Cloud-Barista Development and Testing Support)](#클라우드-바리스타-개발-및-시험-지원-기능-cdt-cloud-barista-development-and-testing-support)
...
![](images/image2.png){width="4.820754593175853in"
...
![](images/image3.png){width="5.533333333333333in"
...
![](images/image4.png){width="5.125in" height="4.916096894138232in"}

그림 3: 멀티 클라우드 서비스 공통 플랫폼 제공 인터페이스 및 사용자
...
![](images/image5.png){width="5.206944444444445in"
...
![](images/image7.png){width="3.9859153543307086in"
...
![](images/image10.png){width="3.6736515748031495in"
...
![](images/image12.png){width="3.3333333333333335in"
...
![](images/image13.png){width="3.4868055555555557in" height="2.625in"}
...
![](images/image14.png){width="3.374361329833771in" height="2.45in"}
...
표 1: 멀티 클라우드 서비스 공통 플랫폼 사용자 요구사항
...
|          | > 관리할 수 있어야 한다.                                  |
+----------+-----------------------------------------------------------+
| UFR-14   | > 멀티 클라우드 인프라 활용 정책 수립 등에 활용하기       |
|          | > 위하여 멀티 클라우드 인프라 연동 이력 정보를 제공해야   |
|          | > 한다.                                                   |
+----------+-----------------------------------------------------------+
| UFR-15   | > 멀티 클라우드 서비스 공통 플랫폼의 개발 및 시험         |
|          | > 편의성을 위하여 가상의 클라우드 환경을 제공해야 한다.   |
+----------+-----------------------------------------------------------+
...
표 2: 클라우드 바리스타 웹/CLI 인터페이스 기능 시스템 요구사항
...
## 클라우드 바리스타 개발 및 시험 지원 기능 (CDT: Cloud-Barista Development and Testing Support)
